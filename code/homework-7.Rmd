...
According to the (2c) model, when adjusting for education, age, parity, and each other, we have  evidence induced abortion is associated with secondary infertility (Wald p<0.001) and evidence spontaneous abortion is associated with secondary infertility (Wald p<0.001). This second model
disagrees with its predecessor regarding the adjusted "effect" of number of induced abortions. Compared to the (1c) model, the association of induced abortions is much stronger in the (2c) model. **As of now, I am uncertain why.**
...
According to the (2d) model, we have insufficient evidence the number of induced abortions modify the adjusted association of number of spontaneous abortions with secondary infertility, or vice versa (LRT p=0.5); this agrees with (1d). **As of now, I am uncertain why.**
...
According to the (3a) model, we do not have sufficient evidence induced abortion is associated with secondary infertility (Wald p=0.9); this agrees with (2a). **As of now, I am uncertain why.**
...
According to the (3b) model, we have sufficient evidence spontaneous abortion is associated with secondary infertility (Wald p<0.001); this agrees with (2b). **As of now, I am uncertain why.**
...
According to the (3c) model, when adjusting for each other, we have evidence induced abortion is associated with secondary infertility (Wald p<0.001) and evidence spontaneous abortion is associated with secondary infertility (Wald p<0.001); these results agree with (2c). **As of now, I am uncertain why.**
...
According to the (3d) model, we have insufficient evidence the number of induced abortions modify the adjusted association of number of spontaneous abortions with secondary infertility, or vice versa (LRT p=0.39); this agrees with (2d). All the "effect" sizes of (3d) are greater than (2d)--some are enormous. **As of now, I am uncertain why.**
...
According to this model, we have __ evidence induced abortion is associated with secondary infertility (Wald p=). 
...
According to this model, we have __ evidence spontaneous abortion is associated with secondary infertility (Wald p=).
...
According to this model, when adjusting for each other, we have ___ evidence induced abortion is associated with secondary infertility (Wald p=) and ___ evidence spontaneous abortion is associated with secondary infertility (Wald p=).
...
According to this model, we have ___ evidence the number of induced abortions modify the association of number of spontaneous abortions with secondary infertility, or vice versa (LRT p=).


## 6. Ordinary logistic regression adjusted for pooled matched sets

**Models 6a) through 6d) repeat models 1a) through 1d) using ordinary logistic regression with dummy variable adjustment for the strata formed by pooling matched sets with like values of the matching variables. For each of a) through d), compare results to those in 5 above. Discuss reasons for the similarities and differences you see.**
...
## 7. Identifying the published model
...
If you were to choose one of the 24 models presented in this Homework to summarize these data in a paper on the relationship of induced abortion to the risk of secondary infertility, which would you choose, and why? 
