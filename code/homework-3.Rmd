...
$\hat P(D=1|X=0)=$ `r q6_probs[2]` . Logistic regression is fit from maximum likelihood estimation (MLE), which tries to best estimate the odds of all subpopulations. See in Figure **this one** that the model best fits the probability, odds, and log odds of disease for each subpopulation. 
